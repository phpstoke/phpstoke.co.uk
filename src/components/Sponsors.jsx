...
const sponsors = [
  { name: 'Pallet Online', logo: logoMollie, link: 'https://mollie.com/?ref=phpstoke' },
  ...
  return (
    <section id="past-sponsors" aria-label="Past Sponsors" className="py-12 sm:py-20">
      <Container>
        ...
        <div className="mx-auto mt-10 grid max-w-max grid-cols-1 place-content-center gap-y-2 gap-x-32 sm:grid-cols-2 md:gap-x-8 lg:gap-x-32">
